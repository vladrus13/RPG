...
public class QuickMenu extends Frame implements Reloaded {
    ...
    public QuickMenu(Frame parent) {
        ...
        ButtonFactory buttonFactory = new ButtonFactory()
                .setChooseBackground(new Background("background", fullStart.copy(), fullSize.copy(), new Filler(Color.BLUE.darker()), null))
                .setBackground(new Background("background", fullStart.copy(), fullSize.copy(), new Filler(Color.BLUE), null));
        TextFactory textFactory = new TextFactory()
                .setTextAlign(Text.TextAlign.LEFT)
                .setFontSize(new Size(900, 0, CoordinatesType.RATIO))
                .setNameFont("MK-90")
                .setColor(Color.BLACK);
        try {
            Size buttonSize = new Size(1000, 500, CoordinatesType.RATIO);
            choose1 = Choose.getInstance("quick", 2, new Point(50, 100, CoordinatesType.RATIO),
                    new Size(300, 100, CoordinatesType.RATIO), this, buttonSize.copy(),
